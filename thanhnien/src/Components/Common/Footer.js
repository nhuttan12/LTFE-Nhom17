        ...
        <div className="containerFoot">
            <footer className="footer">
                        ...
                        <nav>
                            <ul>
                                <div className="footer-contact">
                                    <a href="https://thanhnien.vn/" target="_blank"> <img
                                        src="https://static.thanhnien.com.vn/thanhnien.vn/image/logo-ft.png"
                                        alt="Thanh Nien Logo"/></a>
                                </div>
                                <li><a href="https://datbao.thanhnien.vn/">Đặt báo</a></li>
                                <li><a href="https://banggia.thanhnien.vn/">Quảng cáo</a></li>
                                <li><a href="https://thanhnien.vn/rss.html">RSS</a></li>
                                <li><a href="https://thanhnien.vn/thong-tin-toa-soan.html">Tòa soạn</a></li>
                                <li><a href="https://thanhnien.vn/policy.html">Chính sách bảo mật</a></li>
                                <li className="textblur"><a href="/privacy">Theo dõi báo trên</a></li>
                                <li>
                                    <div className="list-sc">
                                        <a href="https://www.facebook.com/thanhnien" className="item" rel="nofollow"
                                           target="_blank"
                                           title="Facebook">
                                        ...
                                        <a href="https://zalo.me/2431025964363015388" className="item" rel="nofollow"
                                           target="_blank" title="Zalo">
                                            <svg width="32" height="33" viewBox="0 0 32 33" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <rect x="0.5" y="1" width="31" height="31" rx="15.5" stroke="#8B8B8B"/>
                ...
                <div className="footer-bottom">
                    <div className="container">
                        <div className="btomleft">
                            <p>Hotline<br/><a href="tel:0906645777">0906 645 777</a></p>
                            <p>Liên hệ quảng cáo<br/><a href="tel:0908780404">0908 780 404</a></p>
                        </div>
                        <div className="btomcenter">
                            <p>Tổng biên tập: Nguyễn Ngọc Toàn</p>
                            <p>Phó tổng biên tập: Hải Thành </p>
                            <p>Phó tổng biên tập: Lâm Hiếu Dũn</p>
                            <p>Phó tổng biên tập: Trần Việt Hư</p>
                            <p>Tổng thư ký tòa soạn: Đức Trung</p>
                        </div>
                        <div className="btomright">
                            <p>Giấy phép xuất bản số 110/GP - BTTTT cấp ngày 24.3.2020 © 2003-2024 Bản quyền thuộc về
                                Báo Thanh Niên. Cấm
                                sao chép dưới
                                mọi hình thức nếu không có sự chấp thuận bằng văn bản.</p>
                            <p><img src="https://tinnhiemmang.vn/handle_cert?id=thanhnien.vn" alt=""
                                    style={{width: '150px'}}></img></p>
                        </div>
                    </div>
                </div>
            </footer>
